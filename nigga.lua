        ...
        function library:window(properties)
            ...
            local items = cfg.items; do
                ...
                items[ "other_info" ] = library:create( "TextLabel" , {
                    ...
                    TextColor3 = themes.preset.accent;
                    BorderColor3 = rgb(0, 0, 0);
                    Text = '<font color="rgb(72, 72, 73)">' .. cfg.expire .. ', </font>' .. cfg.name .. " " .. cfg.suffix;
                    Size = dim2(1, 0, 0, 0);
                    Position = dim2(0, -10, 0.5, -1);
                    AnchorPoint = vec2(0, 0.5);
                    BorderSizePixel = 0;
...
-- Mobile Toggle Button Injection
    function library:CreateMobileToggle(windowData)
        local ScreenGui = Instance.new("ScreenGui")
        local OpenButton = Instance.new("TextButton")
        local UICorner = Instance.new("UICorner")

        ScreenGui.Name = "MileniumMobileToggle"
        ScreenGui.Parent = coregui
        ScreenGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

        OpenButton.Name = "OpenButton"
        OpenButton.Parent = ScreenGui
        OpenButton.BackgroundColor3 = themes.preset.accent
        ...
        OpenButton.MouseButton1Click:Connect(function()
            ...
            windowData.toggle_menu(isMenuOpen)
        end)
